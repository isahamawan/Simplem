...
function save_as_html(evt) {
    ...
    const under_preview_to_end = '</div></body ><script id="toc_js">let toc_button_ele = document.createElement("button");toc_button_ele.setAttribute("class", "outline no-disable");toc_button_ele.setAttribute("type", "button");toc_button_ele.setAttribute("title", "Outline");toc_button_ele.setAttribute("tabindex", "-1");toc_button_ele.setAttribute("id", "toc_button");let toc_i_ele = document.createElement("i");toc_i_ele.innerText="目次";toc_button_ele.appendChild(toc_i_ele);let editor_toolbar_ele = document.getElementsByClassName("editor-preview-full")[0];editor_toolbar_ele.insertBefore(toc_button_ele, editor_toolbar_ele.firstChild);window.flg_toc_on = true;document.getElementById("toc_button").addEventListener("click", function (e) {if (flg_toc_on == true) {document.getElementById("toc_wrapper").setAttribute("style", "display:block;");} else {document.getElementById("toc_wrapper").setAttribute("style", "display:none;");};flg_toc_on = !flg_toc_on;});</script><link rel="stylesheet" href="css/toc.css"><style id="toc_css"></style></html>';
