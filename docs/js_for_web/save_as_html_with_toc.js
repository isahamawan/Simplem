...
function save_as_html(evt) {
    ...
    const under_style_to_above_toc = '</style></head><body><nav id="div-menu-nav"><div class="menu-tab menu-hover1"><a>' + document.getElementById("file_name_html").value + '</a></div><div class="box1"><div><a id="save_as">PCに名前を付けて保存</a></div><hr class="sepa_menu"><div><a id="print">印刷</a></div></div></nav><div id="toc_wrapper" style="display:block;">';
