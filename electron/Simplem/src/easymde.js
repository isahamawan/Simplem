(function (f) { if (typeof exports === "object" && typeof module !== "undefined") { module.exports = f() } else if (typeof define === "function" && define.amd) { define([], f) } else { var g; if (typeof window !== "undefined") { g = window } else if (typeof global !== "undefined") { g = global } else if (typeof self !== "undefined") { g = self } else { g = this } g.EasyMDE = f() } })(function () {
  var define, module, exports; return (function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
    ...
    }, { "typo-js": 24 }], 3: [function (require, module, exports) {
    ...
    }, { "../../lib/codemirror": 18 }], 4: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 5: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 6: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 7: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 8: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
        ...
        CodeMirror.commands.newlineAndIndentContinueMarkdownList = function (cm) {
          ...
          for (var i = 0; i < ranges.length; i++) {
            ...
            if (emptyListRE.test(line)) {
              ...
              //simplem listナンバーが増えないようにする var bullet = numbered ? (parseInt(match[3], 10)) + match[4] : match[2].replace("x", " ");
              var bullet = numbered ? (parseInt(match[3], 10) + 1) + match[4] : match[2].replace("x", " ");//listナンバーが増える（オリジナル）
              replacements[i] = "\n" + indent + bullet + after;
    ...
    }, { "../../lib/codemirror": 18 }], 9: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 10: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 11: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 12: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18, "../dialog/dialog": 4 }], 13: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18, "../scroll/annotatescrollbar": 11, "./searchcursor": 15 }], 14: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18, "../dialog/dialog": 4, "./searchcursor": 15 }], 15: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
    ...
    }, { "../../lib/codemirror": 18 }], 16: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
      ...
      (function (global, factory) {
        ...
        function hiddenTextarea() {
          //simplem オリジナル変換窓位置調整 var te = elt("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none");
          var te = elt("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none; font-size: 45px;");
          var div = elt("div", [te], null, "overflow: hidden; position: relative; width: 3px; height: 0px;");
          // The textarea is kept positioned near the cursor to prevent the
          // fact that it'll be scrolled into view on input from scrolling
          // our fake cursor out of view. On webkit, when wrap=off, paste is
          // very slow. So make the area wide instead.
          //simplem オリジナル if (webkit) { te.style.width = "1000px"; }
    ...
    }, { "../../addon/mode/overlay": 10, "../../lib/codemirror": 18, "../markdown/markdown": 20 }], 20: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
      ...
      (function (mod) {
        ...
        CodeMirror.defineMode("markdown", function (cmCfg, modeCfg) {
          ...
          var hrRE = /^([*\-_])(?:\s*\1){2,}\s*$/
            ...
            //simplem , atxHeaderRE = modeCfg.allowAtxHeaderWithoutSpace ? /^(#+)/ : /^(#+)(?: |$)/ //オリジナル
    ...
    }, { "../../lib/codemirror": 18, "../meta": 21, "../xml/xml": 22 }], 21: [function (require, module, exports) {
      // CodeMirror, copyright (c) by Marijn Haverbeke and others
      // Distributed under an MIT license: https://codemirror.net/LICENSE
            ...
            if (ch == "<") {
              if (stream.eat("!")) {
                if (stream.eat("[")) {
                  ...
                  return chain(inBlock("memo", "-->")); //simplem コメント部（<!-- -->）に赤字アイデアメモのクラスを追加
    ...
    }, { "codemirror": 18 }], 26: [function (require, module, exports) {
      'use strict';
      var CodeMirror = require('codemirror');
      ...
      //require('cm_search_addon/dialog.js');
      require('codemirror/addon/dialog/dialog.js');
      //require('cm_search_addon/search.js');
      require('codemirror/addon/search/search.js');
      //require('cm_search_addon/annotatescrollbar.js');
      require('codemirror/addon/scroll/annotatescrollbar.js');
      //require('cm_search_addon/matchesonscrollbar.js');
      require('codemirror/addon/search/matchesonscrollbar.js');
      //require('cm_search_addon/jump-to-line.js');
      ...
      */
          ...
          (function (i) {
            ...
            if (direction !== undefined) {
              if (currHeadingLevel <= 0) {
                ...
                //    text = text.substr(7);
              } else if (currHeadingLevel == 3 && direction == 'smaller') { //simplem ショートカットのヘッディングをh3までに変更
                text = text.substr(4);                                    //
      ...
      var toolbarBuiltInButtons = {
        ...
        'guide': {
          ...
          action: '../assets/md-cheat-sheet.pdf',//simplem このpdfの著作権は右記のドメインにあります https://shirokuma-lab.com/
    ...
    }, { "./codemirror/tablist": 25, "codemirror": 18, "codemirror-spell-checker": 2, "codemirror/addon/comment/comment.js": 3, "codemirror/addon/dialog/dialog.js": 4, "codemirror/addon/display/autorefresh.js": 5, "codemirror/addon/display/fullscreen.js": 6, "codemirror/addon/display/placeholder.js": 7, "codemirror/addon/edit/continuelist.js": 8, "codemirror/addon/merge/merge.js": 9, "codemirror/addon/mode/overlay.js": 10, "codemirror/addon/scroll/annotatescrollbar.js": 11, "codemirror/addon/search/jump-to-line.js": 12, "codemirror/addon/search/matchesonscrollbar.js": 13, "codemirror/addon/search/search.js": 14, "codemirror/addon/search/searchcursor.js": 15, "codemirror/addon/selection/active-line.js": 16, "codemirror/addon/selection/mark-selection.js": 17, "codemirror/mode/gfm/gfm.js": 19, "codemirror/mode/markdown/markdown.js": 20, "codemirror/mode/xml/xml.js": 22, "marked/lib/marked": 23 }]
  }, {}, [26])(26)
});
